...
print("-" * 30)
print(f" TOP RESORT: {sorted_resorts[0][0]} ({sorted_resorts[0][1]:,.0f} visitors/year)")
print(f" PEAK WEEK: Week {week_analysis.index[0]} (highest average attendance)")
print(f" SHOULDER SEASONS: Weeks 1-3 and 13-15 (lowest crowds)")
