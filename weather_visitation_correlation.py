...
print("🎿❄️ WEATHER-VISITATION CORRELATION ANALYSIS")
print("=" * 60)
...
print("🗓️ CREATING WEATHER-VISITATION DATASET...")
...
print(f"🌡️ Optimal temperature range: {optimal_temp-1:.1f}°C to {optimal_temp+1:.1f}°C")
print(f"❄️ Optimal snow conditions: {optimal_rainfall:.1f}mm weekly rainfall")
